...
plt.title('Nearest Neighbors Regression(K=15)')
...
data['Nearest Neighbors Regression(k=15)']= pd.DataFrame(data =y_predict_lin[-300:],  index=df.index[-300:])
data.to_csv(path_or_buf='Nearest Neighbors Regression(k=15) output.csv' , sep=',' )